...
from colorTemperature import Lab2sRGBVec
...
class CLAHEForm (QGraphicsView):
    ...
    def __init__(self, targetImage=None, size=500, layer=None, parent=None, mainForm=None):
        ...
        def f():
            ...
            self.tempValue.setText(str("{:d}".format(self.sliderTemp.value())))
            self.onUpdateContrast(self.sliderTemp.value() / 20.0)
        ...
        self.sliderTemp.setValue(self.defaultClipLimit * 20)
        self.tempValue.setText(str("{:d}".format(int(self.defaultClipLimit * 20))))

        # TODO refactor : copied from colorTemp form
